...
---------------------------------- Queries for Covid 19 Data Exploration -------------------------------------------------

-- Downloaded Data from --		https://ourworldindata.org/covid-deaths

/*
 
	Skills used: Standard Queries, Joins, CTE's, Temp Tables, Windows Functions, Aggregate Functions, Creating Views, 
			Converting Data Types, Filter using Where Clause, etc.
